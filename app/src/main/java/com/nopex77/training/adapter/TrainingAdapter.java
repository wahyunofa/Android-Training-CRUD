package com.nopex77.training.adapter;
...
import com.nopex77.training.R;
import com.nopex77.training.activity.HomeActivity;
import com.nopex77.training.activity.ui.training.DetailTrainingActivity;
import com.nopex77.training.helper.Config;
import com.nopex77.training.model.ResponseErrorModel;
import com.nopex77.training.model.TrainingModel;
import com.nopex77.training.rest.ApiConfig;
import com.nopex77.training.rest.ApiService;
    ...
    public void onBindViewHolder(@NonNull TrainingViewHolder holder, final int position) {
        ...
        holder.btnAktifkan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                apiService.postUpdateTraining(trainingModels.get(position).getIdTraining()).enqueue(new Callback<ResponseErrorModel>() {
                    @Override
