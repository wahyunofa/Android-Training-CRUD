...
public interface ApiService {
    ...
    Call<List<TrainingModel>> getTraining(@Query("status_training") String status_training);
    ...
    Call<ResponseErrorModel> postTambahTraining(@Field("kode_training") String kode_training,
    ...
    Call<ResponseErrorModel> postUpdateTraining(@Field("id_training") String id_training);
    @FormUrlEncoded
    @POST("training/api_update_training.php")
    Call<ResponseErrorModel> postDeleteTraining(@Field("id_training") String id_training);
}
